...
function Navbar(props) {
    ...
    return (
        <div className='navbar'>
            ...
            <div className = "skull-div" style = {{height: "2vh",width: "100vw", backgroundImage: `url(${skulls})` ,zIndex: "15", position: "absolute", top: "10vh"}}></div>
            <div className='banner'>
                <img src={powerhouse} />
            </div>
            <div className = "skull-div" style = {{height: "2vh",width: "100vw", backgroundImage: `url(${skulls})`}}>
      </div>
